# Kong Gateway Service Registration Script - Local Development
# This script registers all VNO services to Kong Gateway running on localhost
# Usage: .\register-services-local.ps1

$KONG_ADMIN_URL = "http://localhost:8001"

Write-Host "🚀 Registering VNO Services to Kong Gateway (Local Development)" -ForegroundColor Cyan
...
# Register services
# Note: Services are running on localhost with different ports
